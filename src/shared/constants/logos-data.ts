...
const LOGOS_DATA: LogoItem[] = [
  ...
  },
  {
    ...
    downloadableFiles: {
      icon: {
        ...
        dark: [{ url: 'https://example.com/logos/shopify/icon-dark.png', format: 'png' }],
      },
      text: {
  ...
  },
  {
    ...
    downloadableFiles: {
      icon: {
        light: [
          { url: 'https://example.com/logos/notion/icon-light.svg', format: 'svg' },
          { url: 'https://example.com/logos/notion/icon-light.svg', format: 'png' },
        ],
  ...
  },
  {
    ...
    downloadableFiles: {
      icon: {
        ...
        dark: [{ url: 'https://example.com/logos/openai/icon-dark.svg', format: 'svg' }],
      },
      text: {
  ...
  },
  {
    ...
    downloadableFiles: {
      icon: {
        ...
        dark: [{ url: 'https://example.com/logos/bigcommerce/icon-dark.svg', format: 'svg' }],
      },
      text: {
  ...
  },
  {
    ...
    downloadableFiles: {
      icon: {
        ...
        dark: [{ url: 'https://example.com/logos/stabilityai/icon-dark.svg', format: 'svg' }],
      },
      text: {
